...
public class DeviceController {
    ...
    public ResponseEntity<?> registerDevice(
            ...
            @AuthenticationPrincipal User user) {
        log.info("=== POST /devices/register ===");
        log.info("User: {}", user);
        log.info("Request MAC: {}", request.getMacAddress());
        ...
        try {
            ...
            log.info("Device registered successfully: {}", device);
    ...
    public ResponseEntity<?> deleteDevice(
        ...
        try {
            ...
            if (!deviceLicenses.isEmpty()) {
                return ResponseEntity.status(HttpStatus.CONFLICT)
                        .body(Map.of("error", "Cannot delete device with active licenses"));
            }
    ...
    public ResponseEntity<?> checkDeviceLicense(
        ...
        try {
            ...
            if (licenseOpt.isEmpty()) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
                        .body(Map.of("error", "No active license found"));
            }
